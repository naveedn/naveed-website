...
* Make sure the project is tough, but doable. 
  ...
  * Make every mid-level and senior engineer on your team actually do the project in the same 3 hour window. Don't tell them beforehand, and see how far each person gets. Establish a baseline for candidate performance evaluation based on the lower-bound and upper-bound of completion by members of your team.
